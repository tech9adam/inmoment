    ...
    <div class="container">
      <div class="row banner-content">
        <div class="col-md-8 col-md-offset-2 text-center">
          ...
          <script src="https://fast.wistia.com/embed/medias/acelnnas8i.jsonp" async></script><script src="https://fast.wistia.com/assets/external/E-v1.js" async></script>
          <!-- <span class="wistia_embed wistia_async_acelnnas8i popover=true popoverAnimateThumbnail=true popoverContent=link" style="display:inline">
            <a href="#"class="btn btn-huge"><?php the_field('home_button'); ?></a>
          </span> -->
  ...
  <section class="two-sec-div">
    ...
    if( have_rows('home_sections') ):
      ...
      // loop through the rows of data
		...
		<div class="col-sm-4 <?php if($i==2){echo "second-sec pad-right-0";}else{echo "first-sec pad-left-0"; } ?> ">
			<div class="row">
          ...
          while ( have_rows('inmoment_content') ) : the_row();
             ...
             ?>
              <section class="<?php if($i==2){echo "speed"; }elseif($i==3){echo "moment-different listen";}else{echo "moment-different"; } ?>">
                ...
                <h2><?php  the_sub_field('heading'); ?></h2>
                <p><?php  the_sub_field('content'); ?></p>
            <p><a href="<?php  the_sub_field('learn_more_link'); ?>" class="btn btn-understand-stroke btn-pill-large learn-more-btn org"><?php the_sub_field('learn_more_button'); ?></a></p>
              </div>
                ...
                <?php }else{ ?>
                  <div class="col-md-6 col-sm-12 image-cont big-img "><img src="<?php  the_sub_field('image'); ?>" alt="" class="img-responsive"></div>
                      <div class="col-md-6 col-sm-12 content pull-right">
                        <h2><?php  the_sub_field('heading'); ?></h2>
                        <p><?php  the_sub_field('content'); ?></p>
                    <p><a href="<?php  the_sub_field('learn_more_link'); ?>" class="btn btn-understand-stroke btn-pill-large learn-more-btn <?php if($i==3){echo "grn";} ?>"><?php the_sub_field('learn_more_button'); ?></a></p>
                      </div>
                      <?php } ?>
                </div>
                </section>
