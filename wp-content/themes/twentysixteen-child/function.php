...
function my_acf_options_page_settings( $settings )
{
	...
	$settings['pages'] = array('Header','Footer','Team','Privacy Policy','Language','Button');
    return $settings;
}
...
<a id="<?php echo str_replace($site_url,'',get_permalink());  ?>" class="confirmform" name="<?php echo get_the_title(); ?>"
  data-id="<?php echo get_the_ID(); ?>" <?php  if(!in_array(get_the_ID(), $post_value)){  ?> onclick='show_form( myUrl = "<?php echo str_replace($site_url,'',get_permalink());  ?>",id="<?php echo get_the_ID(); ?>")' <?php }else{?> href="<?php echo str_replace($site_url,'',get_permalink());  ?>"<?php } ?>  >
...
<p>
<?php echo wp_trim_words( get_the_content(), 30, '...' ); ?></p> </div>
...
function btn_shortcode( $atts, $content = null ) {
    $a = shortcode_atts( array(
        'class' => 'btn btn-understand-stroke btn-pill-large learn-more-btn',
        'href'  =>  '#',
        //'onclick'=>'abc()'
    ), $atts );

    return '<a onclick=abc() class="' . esc_attr($a['class']) . '" href="' . esc_attr($a['href']) . '">' . $content . '</a>';
}
